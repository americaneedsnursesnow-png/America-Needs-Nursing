      ...
      <SiteContentWrapper>
        <div className="mx-auto max-w-4xl bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-slate-100">
          ...
          <div className="prose prose-slate max-w-none text-slate-700 space-y-6">
            ...
            <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-4">Contact &amp; Location</h2>
            <div className="not-prose rounded-2xl border border-slate-100 bg-slate-50 p-5 space-y-2 text-sm text-slate-700">
              <p className="flex items-start gap-2">
                <svg className="w-4 h-4 mt-0.5 shrink-0 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                <span><strong>America Needs Nurses</strong><br />1141 Hawthorne Circle, Madison, GA, 30650, USA</span>
              </p>
              <p className="flex items-center gap-2">
                <svg className="w-4 h-4 shrink-0 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                <a href="mailto:support@americaneedsnurses.com" className="text-red-600 hover:underline">support@americaneedsnurses.com</a>
              </p>
              <p className="flex items-center gap-2">
                <svg className="w-4 h-4 shrink-0 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                <a href="tel:+14047542651" className="text-red-600 hover:underline">+1 404-754-2651</a>
              </p>
            </div>
          </div>
        </div>
